...
CREATE TABLE IF NOT EXISTS films (
    ...
    mpa_id BIGINT,
    CONSTRAINT fk_films_mpa FOREIGN KEY (mpa_id) REFERENCES mpa(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS user_friendships (
    ...
    CONSTRAINT fk_user_friendships_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_user_friendships_friend FOREIGN KEY (friend_id) REFERENCES users(id) ON DELETE CASCADE
);
